...
<div class="card mb-1">
    <div class="card-header d-flex justify-content-center">
        ...
        <button class="btn btn-light ml-1" data-toggle="modal" data-target="#exampleModal13" type="button" style="width: 25%; border: 1px solid rgb(213, 213, 213);"><i class="fas fa-phone"></i></button>
        ...
        <button class="btn btn-info ml-1" data-toggle="modal" data-target="#exampleModal15" type="button" style="width: 25%; color: white"><i class="fas fa-edit"></i></button>
    </div>
