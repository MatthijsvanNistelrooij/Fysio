            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr style="background-color: transparent">
                        ...
                        <td><input type="text" value="{{  $sessies->con16 }}" class="form-control mb-1" name="con16" style="width: 98%"></td>
                        <td><input type="text" value="{{  $sessies->con17 }}" class="form-control mb-1" name="con17" style="width: 98%"></td>
                        <td><input type="text" value="{{  $sessies->con18 }}" class="form-control mb-1" name="con18" style="width: 98%"></td>

                    </tr>

                    <tr style="background-color: transparent">
                        <td>volte harde <i style="float: right">l-om</i></td>
                        <td><input type="text" value="{{  $sessies->con19 }}" class="form-control mb-1" name="con19" style="width: 98%"></td>
                        <td><input type="text" value="{{  $sessies->con20 }}" class="form-control mb-1" name="con20" style="width: 98%"></td>
                        <td><input type="text" value="{{  $sessies->con21 }}" class="form-control mb-1" name="con21" style="width: 98%"></td>
                    </tr>

                    <tr>
                        <td><i style="float: right">r-om</i></td>
                        <td><input type="text" value="{{  $sessies->con22 }}" class="form-control mb-1" name="con22" style="width: 98%"></td>
                        <td><input type="text" value="{{  $sessies->con23 }}" class="form-control mb-1" name="con23" style="width: 98%"></td>
                        <td><input type="text" value="{{  $sessies->con24 }}" class="form-control mb-1" name="con24" style="width: 98%"></td>
                    </tr>

                    <tr style="background-color: transparent">
                        <td>rechte lijn zachte</td>
                        <td><input type="text" value="{{ $sessies->con25 }}" class="form-control mb-1" name="con25" style="width: 98%"></td>
                        <td><input type="text" value="{{ $sessies->con26 }}" class="form-control mb-1" name="con26" style="width: 98%"></td>
                        <td><input type="text" value="{{ $sessies->con27 }}" class="form-control mb-1" name="con27" style="width: 98%"></td>
                    </tr>

                    <tr>
                        <td>volte zachte<i style="float: right">l-om</i></td>
                        <td><input type="text" value="{{ $sessies->con28 }}" class="form-control mb-1" name="con28" style="width: 98%"></td>
                        <td><input type="text" value="{{ $sessies->con29 }}" class="form-control mb-1" name="con29" style="width: 98%"></td>
                        <td><input type="text" value="{{ $sessies->con30 }}" class="form-control mb-1" name="con30" style="width: 98%"></td>
                    </tr>

                    <tr style="background-color: transparent">
                        <td><i style="float: right">r-om</i></td>
                        <td><input type="text" value="{{ $sessies->con31 }}" class="form-control mb-1" name="con31" style="width: 98%"></td>
                        <td><input type="text" value="{{ $sessies->con32 }}" class="form-control mb-1" name="con32" style="width: 98%"></td>
                        <td><input type="text" value="{{ $sessies->con33 }}" class="form-control mb-1" name="con33" style="width: 98%"></td>
                    </tr>
