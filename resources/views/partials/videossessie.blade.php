                    ...
                    <table class="table">
                        <thead>
                            ...
                            <tr style="border:1px solid white">
                                <th scope="col" style="border: 1px solid white; text-align: center"><i
                                        class="fas fa-hashtag"
                                        style="color: gray; border: 1px solid rgb(255, 255, 255); border-radius: 50%; padding: 15px"></i>
                                </th>
                                <th scope="col" style="border: 1px solid white; text-align: left"><i
                                        class="fas fa-film"
                                        style="color: gray; border: 1px solid rgb(255, 255, 255); border-radius: 50%; padding: 15px;  box-shadow: 0px 3px 15px rgba(0,0,0,0.2);"></i>
                                </th>
                                <th scope="col" style="border: 1px solid white; text-align: left"><i
                                        class="fas fa-search"
                                        style="color: gray; border: 1px solid rgb(255, 255, 255); border-radius: 50%; padding: 15px;  box-shadow: 0px 3px 15px rgba(0,0,0,0.2);"></i>
                                ...
                                <th scope="col" style="border: 1px solid white; text-align: left"><i
                                        class="far fa-file"
                                        style="color: gray; border: 1px solid rgb(255, 255, 255); border-radius: 50%; margin-left: 18px; padding: 15px;  box-shadow: 0px 3px 15px rgba(0,0,0,0.2);"></i>
                                </th>
                            </tr>
                            </tr>
                        </thead>
                        <tbody>
                            <tr style="border: 1px solid white">
                                ...
                                <td style="width: 90%"><input type="file" name="image9" id="" class="form-control mb-2"
                                        value="{{ $sessies->image9 }}"></td>
                                <td><video width="100" height="60" style="margin-top: 0px" controls>
                                        <source src="/storage/images/{{ $sessies->image9 }}" type="video/mp4">
                                    </video></td>
                                <td>
                                    <p style="text-align: center"><input type="checkbox" name="con178" value="1"
                                            class="form-check-input" style="margin-left: 2px"></span></p>
                                </td>
                            </tr>
                            <tr style="border: 1px solid white">

                                <td style="color: gray; text-align: center">2</td>
                                <td style="width: 90%"><input type="file" name="image10" id="" class="form-control mb-2"
                                        value="{{ $sessies->image10 }}"></td>
                                <td><video width="100" height="60" style="margin-top: 0px" controls>
                                        <source src="/storage/images/{{ $sessies->image10 }}" type="video/mp4">
                                    </video></td>
                                <td>
                                    <p style="text-align: center"><input type="checkbox" name="con179" value="1"
                                            class="form-check-input" style="margin-left: 2px"></span></p>
                                </td>
                            </tr>
                            <tr style="border: 1px solid white">
                                <td style="color: gray; text-align: center">3</td>
                                <td style="width: 90%"><input type="file" name="image11" id="" class="form-control mb-2"
                                        value="{{ $sessies->image11 }}"></td>
                                <td><video width="100" height="60" style="margin-top: 0px" controls>
                                        <source src="/storage/images/{{ $sessies->image11 }}" type="video/mp4">
                                    </video></td>
                                <td>
                                    <p style="text-align: center"><input type="checkbox" name="con180" value="1"
                                            class="form-check-input" style="margin-left: 2px"></span></p>
                                </td>
                            </tr>
                            <tr style="border: 1px solid white">
                                <td style="color: gray; text-align: center">4</td>
                                <td style="width: 90%"><input type="file" name="image12" id="" class="form-control mb-2"
                                        value="{{ $sessies->image12 }}"></td>
                                <td><video width="100" height="60" style="margin-top: 0px" controls>
                                        <source src="/storage/images/{{ $sessies->image12 }}" type="video/mp4">
                                    </video></td>
                                <td>
                                    <p style="text-align: center"><input type="checkbox" name="con181" value="1"
                                            class="form-check-input" style="margin-left: 2px"></span></p>
                                </td>
                            </tr>
                            ...
                            <tr style="border: 1px solid white">
                                ...
                                <td style="width: 90%"><input type="file" name="image13" id="" class="form-control mb-2"
                                        value="{{ $sessies->image13 }}"></td>
                                <td><video width="100" height="60" style="margin-top: 0px" controls>
                                        <source src="/storage/images/{{ $sessies->image13 }}" type="video/mp4">
                                    </video></td>
                                <td>
                                    <p style="text-align: center"><input type="checkbox" name="con191" value="1"
                                            class="form-check-input" style="margin-left: 2px"></span></p>
                                </td>
                            </tr>
                            <tr style="border: 1px solid white">
                                ...
                                <td style="width: 90%"><input type="file" name="image14" id="" class="form-control mb-2"
                                        value="{{ $sessies->image14 }}"></td>
                                <td><video width="100" height="60" style="margin-top: 0px" controls>
                                        <source src="/storage/images/{{ $sessies->image14 }}" type="video/mp4">
                                    </video></td>
                                <td>
                                    <p style="text-align: center"><input type="checkbox" name="con192" value="1"
                                            class="form-check-input" style="margin-left: 2px"></span></p>
                                </td>
                            </tr>
                            <tr style="border: 1px solid white">
                                ...
                                <td style="width: 90%"><input type="file" name="image15" id="" class="form-control mb-2"
                                        value="{{ $sessies->image15 }}"></td>
                                <td><video width="100" height="60" style="margin-top: 0px" controls>
                                        <source src="/storage/images/{{ $sessies->image15 }}" type="video/mp4">
                                    </video></td>
                                <td>
                                    <p style="text-align: center"><input type="checkbox" name="con193" value="1"
                                            class="form-check-input" style="margin-left: 2px"></span></p>
                                </td>
                            </tr>
                            {{-- <tr style="border: 1px solid white">
