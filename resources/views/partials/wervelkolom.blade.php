        ...
        <div class="row">
            <div class="col-md-4 col-sm-12" style="overflow:scroll; height: 700px; overflow-x: hidden; margin-bottom: 50px; min-width: 300px">
                ...
                <div id="demo5" class="collapse">
                    ...
                    <input type="text" class="form-control mt-1 mb-1" name="con{{ $sessies->con65 }}" placeholder="..." value="{{ $sessies->con65 }}">
                </div>
                ...
                <div id="demo6" class="collapse">
                    ...
                    <input type="text" class="form-control mt-1" name="con65" value="{{ $sessies->con66 }}" placeholder="...">
...
<div id="demo11" class="collapse">
    ...
    <input type="text" class="form-control mt-1 mb-1" ame="con84" value="{{ $sessies->con84 }}" placeholder="...">
