    ...
    <form action="{{ route('sessies.update', ['id' => $sessies->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-content">
              <div class="modal-header">
                <input type="radio" name="con175" id="" value="fas fa-square" checked="checked" class="mt-2 mr-2">

              <h5 class="modal-title" id="exampleModalLongTitle">Specifieke Palpatie:</h5>
              ...
              <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <textarea name="con176" id="" cols="30" rows="5" class="form-control" style="margin-bottom: 5px" placeholder="...">{{ $sessies->con176 }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <textarea name="con177" id="" cols="30" rows="5" class="form-control" placeholder="..." >{{ $sessies->con177 }}</textarea>
                    </div>
                </div>
            </div>
