<div class="modal-dialog modal-dialog modal-xl"  role="document">
    ...
    <div class="modal-content">
          <div class="modal-header">
            <input type="radio" name="con8" id="" value="fas fa-square" checked="checked" class="mt-2 mr-2">
          <h5 class="modal-title" id="exampleModalLongTitle">Inspectie in stand:</h5>
          ...
          <div class="modal-body mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <textarea type="text" cols="10" rows="3" class="form-control" name="con4" id="" style="margin-bottom: 5px" placeholder="...">{{ $sessies->con4 }}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <textarea type="text"  cols="10" rows="3" class="form-control" name="con5" id="" style="margin-bottom: 5px" placeholder="...">{{ $sessies->con5 }}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <textarea type="text"  cols="10" rows="3" class="form-control" name="con6" id="" style="margin-bottom: 5px" placeholder="...">{{ $sessies->con6 }}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <textarea type="text"  cols="10" rows="3" class="form-control" name="con7" id="" placeholder="...">{{ $sessies->con7 }}</textarea>
                        </div>
                    </div>
                        <br>
                    </div>
