<div class="modal-dialog modal-dialog modal-xl">
    ...
    <div class="modal-content">
          ...
          <h5 class="modal-title" id="exampleModalLongTitle">Oefeningen:</h5>
          ...
          <div class="modal-body mb-3">
            ...
            <div class="container">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2">
                            <input type="radio" name="con171" id="" value="https://www.youtube.com/embed/NS_QKmS5uFU">
                        </div>
                        <div class="col-md-4">
                            <iframe width="auto" height="auto" src="https://www.youtube.com/embed/NS_QKmS5uFU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div class="col-md-2">
                            <input type="radio" name="con172" id="" value="https://www.youtube.com/embed/-M00yG9l_Jo">
                        </div>
                        <div class="col-md-4">
                            <iframe width="auto" height="auto" src="https://www.youtube.com/embed/-M00yG9l_Jo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
                            <input type="radio" name="con173" id="" value="https://www.youtube.com/embed/CDQUq_fnU1o">
                        </div>
                        <div class="col-md-4">
                            <iframe width="auto" height="auto" src="https://www.youtube.com/embed/CDQUq_fnU1o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
