      ...
      <div class="modal-dialog modal-dialog modal-xl"  role="document">
        ...
        <div class="modal-content">
              <div class="modal-header">
                <input type="radio" name="con3" id="" value="fas fa-square" checked="checked" class="mt-2 mr-2">

              <h5 class="modal-title" id="exampleModalLongTitle">Algemene Indruk:</h5>
            ...
            <textarea type="text" name="con15" id="" cols="5" rows="5" class="form-control" placeholder="Algemene indruk...">{{ $sessies->con15 }}</textarea>
        </div>
        <div class="inputs">
