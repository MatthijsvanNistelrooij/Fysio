...
<div class="row">
    ...
    <div class="col">
        <div class="tile" id="theme2" data-toggle="modal" data-target="#exampleModal2">
...
<div class="row">
    <div class="col">
        <div class="tile" id="theme3" data-toggle="modal" data-target="#exampleModal3" style="margin-left: 20%">
