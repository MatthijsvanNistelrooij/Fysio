<div class="modal-dialog modal-dialog modal-xl" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body mb-3" style="padding: 2%">
            <div>
                <form action="{{ route('horses.update', ['id' => $horses->id]) }}" method="POST"
                    ...
                    <table class="table" style="border: none">
                        ...
                        <tbody>
                            <tr style="border:1px solid white">
                                ...
                                <td style="width: 85%"><input type="file" name="image" id="" class="form-control mb-2"
                                        value="{{ $horses->image }}"></td>
                                <td><img src="/storage/images/{{ $horses->image }}" alt="" style="width: 100%"></td>
                            </tr>
                            <tr style="border:1px solid white">
                                <td style="color: gray; text-align: center">2</td>

                                <td style="width: 85%"><input type="file" name="image2" id="" class="form-control mb-2"
                                        value="{{ $horses->image2 }}"></td>
                                <td><img src="/storage/images/{{ $horses->image2 }}" alt="" style="width: 100%"></td>
                            </tr>
                            <tr style="border:1px solid white">
                                <td style="color: gray; text-align: center">3</td>

                                <td style="width: 85%"><input type="file" name="image3" id="" class="form-control mb-2"
                                        value="{{ $horses->image3 }}"></td>
                                <td><img src="/storage/images/{{ $horses->image3 }}" alt="" style="width: 100%"></td>
                            </tr>
                            <tr style="border:1px solid white">
                                <td style="color: gray; text-align: center">4</td>

                                <td style="width: 85%"><input type="file" name="image4" id="" class="form-control mb-2"
                                        value="{{ $horses->image4 }}"></td>
                            ...
                            <tr style="border:1px solid white">
                                ...
                                <td style="width: 85%"><input type="file" name="image5" id="" class="form-control mb-2"
                                        value="{{ $horses->image4 }}"></td>
                            ...
                            <tr style="border:1px solid white">
                                ...
                                <td style="width: 85%"><input type="file" name="image6" id="" class="form-control mb-2"
                                        value="{{ $horses->image6 }}"></td>
                                <td><img src="/storage/images/{{ $horses->image6 }}" alt="" style="width: 100%"></td>
                            </tr>
                            <tr style="border:1px solid white">
                                <td style="color: gray; text-align: center">7</td>

                                <td style="width: 85%"><input type="file" name="image7" id="" class="form-control mb-2"
                                        value="{{ $horses->image7 }}"></td>
                                <td><img src="/storage/images/{{ $horses->image7 }}" alt="" style="width: 100%"></td>
                            </tr>
                            <tr style="border:1px solid white">
                                <td style="color: gray; text-align: center">8</td>

                                <td style="width: 85%"><input type="file" name="image8" id="" class="form-control mb-2"
                                        value="{{ $horses->image8 }}"></td>
