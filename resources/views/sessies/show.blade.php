...
<div class="row" style="width: 100%; margin-left: 4%; margin-top: -6px">
    <div class="col">
        <button type="button" class="tile5" data-toggle="modal" data-target="#exampleModal2">
        <h6 class="zoom">
             TMJ / HYOID<br>
     ...
     <div class="col">
         <button type="button" class="tile6" data-toggle="modal" data-target="#exampleModal4">
        <h6 class="zoom">
             Wervelkolom <br>
            ...
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <div class="col-md-4" style="overflow:scroll; height: 650px; overflow-x: hidden; margin-bottom: 50px">
                                ...
                                <div id="demo4" class="collapse">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="bo19" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo19 }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2 mt-1">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="bo20" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo20 }}">
                                        </div>
                                    </div>
                                    <h6 for="lateral" class="title">Flexie</h6>
                                ...
                                <div id="demo5" class="collapse">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="bo27" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo27 }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2 mt-1">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="bo28" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo28 }}">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="bo29" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo29 }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2 mt-1">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="bo30" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo30 }}">
                                        </div>
                                    </div>
                                    <br>
                                ...
                                <div id="demo6" class="collapse">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="bo34" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo34 }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2 mt-1">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="bo35" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo35 }}">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="bo38" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo38 }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2 mt-1">
                ...
                <div id="demo7" class="collapse">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo40" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo40 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="bo41" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo41 }}">
                            </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo42" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo42 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                ...
                <div id="demo8" class="collapse">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo44" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo44 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="bo45" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo45 }}">
                            </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo46" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo46 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                ...
                <div id="demo9" class="collapse">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo48" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo48 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                ...
                <div id="demo11" class="collapse">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo52" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo52 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="bo53" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo53 }}">
                            </div>
                            </div>
                            <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo54" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo54 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="bo55" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo55 }}">
                            </div>
                            </div>
                            <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo56" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo56 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="bo57" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo57 }}">
                            </div>
                            </div>
                            <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo58" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo58 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="bo59" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo59 }}">
                            </div>
                            </div>
                            <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="bo62" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo62 }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 mt-1">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="bo63" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo63 }}">
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="bo64" class="form-control" style="margin-top: 5px" value="{{ $sessie->bo64 }}">
                                </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2 mt-1">
      ...
      <div class="modal-content">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4" style="overflow:scroll; height: 650px; overflow-x: hidden; margin-bottom: 50px">
                        ...
                        <div id="demo41" class="collapse">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-1">
                                     <input type="text" class="form-control" name="bbl1" value="{{ $sessie->bbl1 }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                     <input type="text" class="form-control" name="bbr1" value="{{ $sessie->bbr1 }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-1">
                                    <input type="text" class="form-control" name="bbl2" value="{{ $sessie->bbl2 }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">re </div>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="bbr2" value="{{ $sessie->bbr2 }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 mt-1">li</div>
                                <div class="col-md-10 mb-1">
                                    <input type="text" class="form-control" name="bbl3" value="{{ $sessie->bbl3 }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">re </div>
                                <div class="col-md-10 mb-2">
                                    <input type="text" class="form-control" name="bbr3" value="{{ $sessie->bbr3 }}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="demo42" class="collapse">
                        ...
                        <div class="row">
                            <div class="col-md-2 mt-1">li</div>
                            <div class="col-md-10 mb-1">
                                <input type="text" class="form-control" name="bbl4"  value="{{ $sessie->bbl4 }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-2">re</div>
                            <div class="col-md-10">
                                <input type="text" class="form-control"  name="bbr4"  value="{{ $sessie->bbr4 }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-2 mt-1">li</div>
                            <div class="col-md-10 mb-1">
                                <input type="text" class="form-control" name="bbl5" value="{{ $sessie->bbl5 }}">
                            </div>
                        </div>
                            <div class="row">
                                <div class="col-md-2">re</div>
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="bbr5" value="{{ $sessie->bbr5 }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-2 mt-1">li</div>
                            <div class="col-md-10 mb-1">
                                <input type="text" class="form-control" name="bbl6" value="{{ $sessie->bbl6 }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">re</div>
                            <div class="col-md-10 mb-2">
                                <input type="text" class="form-control" name="bbr6" value="{{ $sessie->bbr6 }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="demo43" class="collapse">
                        ...
                        <div class="row">
                            <div class="col-md-2 mt-1">li</div>
                            <div class="col-md-10 mb-1">
                                <input type="text" class="form-control" name="bbl7" value="{{ $sessie->bbl7 }}">
                        ...
                        <div class="row">
                            <div class="col-md-2">re</div>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="bbr7" value="{{ $sessie->bbr7 }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-2 mt-1">li</div>
                            <div class="col-md-10 mb-1">
                                <input type="text" class="form-control" name="bbl8" value="{{ $sessie->bbl8 }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">re</div>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="bbr8" value="{{ $sessie->bbr8 }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-2 mt-1">li</div>
                            <div class="col-md-10 mb-1">
                                <input type="text" class="form-control" name="bbl9" value="{{ $sessie->bbl9 }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">re</div>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="bbr9" value="{{ $sessie->bbr9 }}">
                            </div>
                        </div>
                    </div>
                ...
                <div id="demo73" class="collapse">
                    ...
                    <div class="row">
                        <div class="col-md-2 mt-1">li</div>
                        <div class="col-md-10 mb-1">
                            <input type="text" class="form-control" name="bbl10" value="{{ $sessie->bbl10 }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">re</div>
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="bbr10" value="{{ $sessie->bbr10 }}">
                    ...
                    <div class="row">
                        <div class="col-md-2 mt-1">li</div>
                        <div class="col-md-10 mb-1">
                            <input type="text" class="form-control" name="bbl11" value="{{ $sessie->bbl11 }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">re</div>
                        <div class="col-md-10 mb-2">
                            <input type="text" class="form-control" name="bbr11" value="{{ $sessie->bbr11 }}">
                        </div>
                    </div>
                </div>
                ...
                <div id="demo44" class="collapse">
                    ...
                    <div class="row">
                        <div class="col-md-2 mt-1">li</div>
                        <div class="col-md-10 mb-1">
                            <input type="text" class="form-control" name="bbl12" value="{{ $sessie->bbl12 }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">re</div>
                        <div class="col-md-10 mb-2">
                            <input type="text" class="form-control" name="bbr12" value="{{ $sessie->bbr12 }}">
                        </div>
                    </div>
                </div>
                ...
                <div id="demo45" class="collapse">
                    ...
                    <div class="row">
                        <div class="col-md-2 mt-1">li</div>
                        <div class="col-md-10 mb-1">
                            <input type="text" class="form-control" name="bbl13" value="{{ $sessie->bbl13 }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2 mt-1">re</div>
                        <div class="col-md-10 mb-2">
                            <input type="text" class="form-control" name="bbr13" value="{{ $sessie->bbr13 }}">
                        </div>
                    </div>
                ...
                <div id="demo46" class="collapse">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 mb-1">
                            <input type="text" class="form-control" name="bbl14" value="{{ $sessie->bbl14 }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2 mt-1">re</div>
                        <div class="col-md-10 mb-2">
                            <input type="text" class="form-control" name="bbr14" value="{{ $sessie->bbr14 }}">
                        </div>
                    </div>
                </div>
                ...
                <div id="demo47" class="collapse">
                    ...
                    <div class="row">
                        <div class="col-md-2">li</div>
                        <div class="col-md-10 mb-1">
                            <input type="text" class="form-control" name="bbl15" value="{{ $sessie->bbl15 }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">re</div>
                        <div class="col-md-10 mb-2">
                            <input type="text" class="form-control" name="bbr15" value="{{ $sessie->bbr15 }}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">li</div>
                        <div class="col-md-10 mb-1">
                            <input type="text" class="form-control" name="bbl16" value="{{ $sessie->bbl16 }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">re</div>
                ...
                <div id="demo48" class="collapse">
                    ...
                    <div class="row">
                        <div class="col-md-2">li</div>
                        <div class="col-md-10 mb-1">
                            <input type="text" class="form-control" name="bbl17" value="{{ $sessie->bbl17 }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">re</div>
                        <div class="col-md-10 mb-2">
                            <input type="text" class="form-control" name="bbr17" value="{{ $sessie->bbr17 }}">
                        </div>
                    </div>
        </div>
        ...
        <div id="demo49" class="collapse">
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl18" value="{{ $sessie->bbl18 }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr18" value="{{ $sessie->bbr18 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl19" value="{{ $sessie->bbl19 }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr19" value="{{ $sessie->bbr19 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl20" value="{{ $sessie->bbl20 }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr20" value="{{ $sessie->bbr20 }}">
                </div>
            </div>
        </div>
        ...
        <div id="demo50" class="collapse">
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl21" value="{{ $sessie->bbl21 }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10">
                    <input type="text" class="form-control" name="bbr21" value="{{ $sessie->bbr21 }}">
                </div>
            </div>
            <h6 for="lateral" class="title">Abduction-adduction</h6>
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl22" value="{{ $sessie->bbl22 }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10">
                    <input type="text" class="form-control" name="bbr22" value="{{ $sessie->bbr22 }}">
                </div>
            </div>
            <h6 for="lateral" class="title">Internal-external rotation</h6>
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control"  name="bbl23" value="{{ $sessie->bbl23 }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 mt-1">re</div>
        ...
        <div id="demo51" class="collapse">
            ...
            <div class="row">
                <div class="col-md-2">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl24" value="{{ $sessie->bbl24 }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr24" value="{{ $sessie->bbr24 }}">
                </div>
            </div>
        </div>
        ...
        <div id="demo52" class="collapse">
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl25" value="{{ $sessie->bbl25 }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr25" value="{{ $sessie->bbr25 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl26" value="{{ $sessie->bbl26 }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 mt-1">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr26" value="{{ $sessie->bbr26 }}">
                </div>
            </div>
        </div>
        ...
        <div id="demo53" class="collapse">
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl27" value="{{ $sessie->bbl27 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr27" value="{{ $sessie->bbr27 }}">
                </div>
            </div>
            ...
            <h6 for="lateral" class="title">Internal-external rotation</h6>
               <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl28" value="{{ $sessie->bbl28 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr28" value="{{ $sessie->bbr28 }}">
                </div>
            </div>
            <h6 for="lateral" class="title">Abduction-adduction</h6>
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl29" value="{{ $sessie->bbl29 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr29" value="{{ $sessie->bbr29 }}">
                </div>
            </div>
        </div>
        ...
        <div id="demo54" class="collapse">
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl30" value="{{ $sessie->bbl30 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr30" value="{{ $sessie->bbr30 }}">
                </div>
            </div>
            <h6 for="lateral" class="title">Internal-external rotation</h6>
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl31" value="{{ $sessie->bbl31 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr31" value="{{ $sessie->bbr31 }}">
                </div>
            </div>
        </div>
        ...
        <div id="demo55" class="collapse">
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl32" value="{{ $sessie->bbl32 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr32" value="{{ $sessie->bbr32 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl33" value="{{ $sessie->bbl33 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr33" value="{{ $sessie->bbr33 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2 mt-1">li</div>
                <div class="col-md-10 mb-1">
                    <input type="text" class="form-control" name="bbl34" value="{{ $sessie->bbl34 }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-2">re</div>
                <div class="col-md-10 mb-2">
                    <input type="text" class="form-control" name="bbr34" value="{{ $sessie->bbr34 }}">
                </div>
            </div>
                </div>
...
<table class="table" style="font-size: 15px">
    ...
    <tbody>
        ...
        <tr>
            ...
            <th>
                Abduction-adduction <p style="font-weight: initial">{{ $sessie->bbr8 }}</p>
            </th>
            <th>
