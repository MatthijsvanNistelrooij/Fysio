...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            @endif
                <a  class="btn btn-primary mb-1" style="width: 100%" href="{{ URL::to('/horses/' . $sessies->horse_id ) }}" style="text-decoration: none; color: rgb(255, 255, 255)">
                    <i class="far fa-arrow-alt-circle-left"></i>
                    Terug naar Paard ID: {{ $sessies->horse_id}}
                </a>
                <a class="btn btn-info mb-1" style="width: 100%; color: white" href="/sessies/{{$sessies->id}}" style="text-decoration: none; color: rgb(255, 255, 255)">
                    <i class="far fa-arrow-alt-circle-left"></i>
            ...
            <div class="row">
                ...
                <div class="col-11">
                    <p style="font-weight: bold; ">Foto's</p>
                        @if($sessies->con183 == true)
                        <img src="/storage/images/{{ $sessies->image }}" alt="" style="width: 10%; margin-left: 10px">@endif
                        @if($sessies->con184 == true)
                        <img src="/storage/images/{{ $sessies->image2 }}" alt="" style="width: 10%; margin-left: 10px">@endif
                        @if($sessies->con185 == true)
                        <img src="/storage/images/{{ $sessies->image3 }}" alt="" style="width: 10%; margin-left: 10px">@endif
                        @if($sessies->con186 == true)
                        <img src="/storage/images/{{ $sessies->image4 }}" alt="" style="width: 10%; margin-left: 10px">@endif
                        @if($sessies->con187 == true)
                        <img src="/storage/images/{{ $sessies->image5 }}" alt="" style="width: 10%; margin-left: 10px">@endif
                        @if($sessies->con188 == true)
                        <img src="/storage/images/{{ $sessies->image6 }}" alt="" style="width: 10%; margin-left: 10px">@endif
                        @if($sessies->con189 == true)
                        <img src="/storage/images/{{ $sessies->image7 }}" alt="" style="width: 10%; margin-left: 10px">@endif
                        @if($sessies->con190 == true)
                        <img src="/storage/images/{{ $sessies->image8 }}" alt="" style="width: 10%; margin: 10px">@endif
                        <br><br>
                    @endif
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-11">
                    ...
                    <p style="font-weight: bold;">Video's</p>
                        @if($sessies->con178 == true)<video width="24%" height="auto" controls><source src="/storage/images/{{ $sessies->image9 }}" type="video/mp4"></video>@endif
                        @if($sessies->con179 == true)<video width="24%" height="auto" controls><source src="/storage/images/{{ $sessies->image10 }}" type="video/mp4"></video>@endif
                        @if($sessies->con180 == true)<video width="24%" height="auto" controls><source src="/storage/images/{{ $sessies->image11 }}" type="video/mp4"></video>@endif
                        @if($sessies->con181 == true)<video width="24%" height="auto" controls><source src="/storage/images/{{ $sessies->image12 }}" type="video/mp4"></video>@endif
                        @if($sessies->con191 == true)<video width="24%" height="auto" controls><source src="/storage/images/{{ $sessies->image13 }}" type="video/mp4"></video>@endif
                        @if($sessies->con192 == true)<video width="24%" height="auto" controls><source src="/storage/images/{{ $sessies->image14 }}" type="video/mp4"></video>@endif
                        @if($sessies->con193 == true)<video width="24%" height="auto" controls><source src="/storage/images/{{ $sessies->image15 }}" type="video/mp4"></video>@endif
                        <br>
                        <br>
                        @endif
                    </div>
                    ...
                    <div class="row mt-2 mb-4">
                        ...
                        <div class="col-11">
                            ...
                            <div class="container">
                                <h6 class="rapport2">{{ $sessies->con170 }}</h6>@endif
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-11">
                                ...
                                <div class="container">
                                    ...
                                    @if($sessies->con4 == true)<h6 class="rapport2">Voorzijde: {{ $sessies->con4 }} </h6>@endif
                                    @if($sessies->con5 == true)<h6 class="rapport2">Achterzijde: {{ $sessies->con5 }} </h6>@endif
                                    @if($sessies->con6 == true)<h6 class="rapport2">Linkerzijde: {{ $sessies->con6 }} </h6>@endif
                                    @if($sessies->con7 == true)<h6 class="rapport2">Rechterzijde: {{ $sessies->con7 }} </h6>@endif
                                </div>
                                <br>
                                @endif
                            </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-11">
                                ...
                                <div class="container">
                                    @if ($sessies->con15 == true)<h6 class="rapport2"> {{ $sessies->con15 }} </h6>@endif
                                </div>
                                <br>
                                @endif
                            </div>
            ...
            {{--        OPP  PALPATIE --}}
                    <div class="row mt-2">
                        ...
                        <div class="col-11">
                            ...
                            <div class="container">
                                @if($sessies->con35 == true)<h6 class="rapport2">Voor inspectie in beweging:  {{ $sessies->con35 }} </h6>@endif
                                @if($sessies->con36 == true)<h6 class="rapport2">Na inspectie in beweging:  {{ $sessies->con36 }} </h6>@endif
                                </div>
                                <br>
                            @endif
                        </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-11">
                    ...
                    <div class="container">
                        @if($sessies->con176 == true)<h6 class="rapport2">Voor inspectie in beweging:  {{ $sessies->con176 }} </h6>@endif
                        @if($sessies->con177 == true)<h6 class="rapport2">Na inspectie in beweging:  {{ $sessies->con177 }} </h6>@endif
                    </div>
                    <br>
                @endif
            </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-11">
                    ...
                    <div class="container">
                        @if($sessies->con172 == true)<h6 class="rapport2">Harnachement: {{ $sessies->con172 }}</h6>@endif
                        @if($sessies->con173 == true)<h6 class="rapport2">Neurologische Onderzoek: {{ $sessies->con173 }}</h6>@endif
                        @if($sessies->con174 == true)<h6 class="rapport2">Beweging onder het zadel: {{ $sessies->con174 }}</h6>@endif
                    </div>
                    @endif
                    <br>
                </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-11">
                    ...
                    <div class="container">
                        ...
                        <h6>Lateral links: {{ $sessies->con37 }}</h6>@endif
                        @if($sessies->con38 == true)<h6 class="rapport2">Lateral rechts: {{ $sessies->con38 }}</h6>@endif
                        @if($sessies->con39 == true)<h6 class="rapport2">Caudal glide links: {{ $sessies->con39 }}</h6>@endif
                        @if($sessies->con40 == true)<h6 class="rapport2">Caudal glide rechts: {{ $sessies->con40 }}</h6>@endif
                        @if($sessies->con41 == true)<h6 class="rapport2">Rostral glide links: {{ $sessies->con41 }}</h6>@endif
                        @if($sessies->con42 == true)<h6 class="rapport2">Rostral glide rechts: {{ $sessies->con42 }}</h6>@endif
                        <br>
                        @if($sessies->con43 == true)<h6>
                            <p style="font-weight: bold;">Hyoid</p>

                            Dorsal: {{ $sessies->con43 }}</h6>@endif
                        @if($sessies->con44 == true)<h6 class="rapport2">Lateral links: {{ $sessies->con44 }}</h6>@endif
                        @if($sessies->con45 == true)<h6 class="rapport2">Lateral rechts: {{ $sessies->con45 }}</h6><br>@endif
                    </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-11">
                    ...
                    <h6> {{ $sessies->con46 }} </h6>@endif

                            @if ($sessies->con47 == true)
                            <br>

                            <p style="font-weight: bold;">C0-C1</p>
                            <h6>Flexie: {{ $sessies->con47 }} </h6>@endif
                            ...
                            <h6>Rotatie links: {{ $sessies->con51 }} </h6>@endif
                            ...
                            <h6>General Latflex CWK links: {{ $sessies->con53 }} </h6>@endif
                            ...
                            <h6>Lateroflexie links: {{ $sessies->con55 }} </h6>@endif
                            ...
                            <h6>General Flexion: {{ $sessies->con59 }} </h6>@endif
                            ...
                            <h6>Active Extension Cranial - Caudal: {{ $sessies->con66 }} </h6>@endif
                            ...
                            <h6>Cranial - Caudal - Cranial links: {{ $sessies->con73 }} </h6>@endif
                            ...
                            <h6>Extension SP links: {{ $sessies->con77 }} </h6>@endif
                            ...
                            <h6>Extension Intertransverse links: {{ $sessies->con81 }} </h6>@endif
                            ...
                            <h6>Extension: {{ $sessies->con83 }} </h6>@endif


                            @if ($sessies->con84 == true)
                            <br>
                            <p style="font-weight: bold;">Pelvic</p>
                            <h6>General Squeeze: {{ $sessies->con84 }} </h6>@endif
                            ...
                            <h6> Flexion-extension: {{ $sessies->con99 }} </h6>@endif
            ...
            <div class="row mt-2">
                ...
                <div class="col-11">
                    ...
                    <div class="container">
                            ...
                            @if($sessies->con101 == true)<h6><p style="font-weight: bold;">Front DIJ</p>
                                flexion extension links: {{ $sessies->con101 }}</h6>@endif
                            ...
                            <h6>flexion extension rechts: {{ $sessies->con107 }}</h6>@endif
                            ...
                            <h6>flexion extension rechts: {{ $sessies->con113 }}</h6>@endif
                            ...
                            <h6>Flexion extension links: {{ $sessies->con119 }}</h6>@endif
                            ...
                            <h6>Lateral-medial motion links: {{ $sessies->con123 }}</h6>@endif
                            ...
                            <h6>Flexion-extension links: {{ $sessies->con125 }}</h6>@endif
                            ...
                            <h6>Flexion abduction/adduction links: {{ $sessies->con127 }}</h6>@endif
                            ...
                            <h6>Elevation-depression links: {{ $sessies->con129 }}</h6>@endif
                            ...
                            <br>                    <p style="font-weight: bold;">Front leg general</p>
                            <h6>Protraction + ab-/adduction links: {{ $sessies->con133 }}</h6>@endif
                            ...
                            <h6>Flexion extension links: {{ $sessies->con135 }}</h6>@endif
                            ...
                            @if($sessies->con141 == true)          <br>

                            <p style="font-weight: bold;">Hind PIJ</p>
                            <h6>Flexion extension links:  {{ $sessies->con141 }}</h6>@endif
                            ...
                            <p style="font-weight: bold;">MPJ</p>
                            <h6>Flexion-extension links: {{ $sessies->con147 }}</h6>@endif
                            @if($sessies->con148 == true)<h6>Flexion-extension rechts: {{ $sessies->con148 }}</h6>@endif


                            @if($sessies->con149 == true)         <br>
                            <p style="font-weight: bold;">Tarsal joint</p>
                            <h6>Flexion-extension links: {{ $sessies->con149 }}</h6>@endif
                            ...
                            @if($sessies->con153 == true)                 <br>
                            <p style="font-weight: bold;">Stiffle</p>
                            <h6>Flexion links: {{ $sessies->con153 }}</h6>@endif
                            ...
                            @if($sessies->con159 == true)          <br>
                            <p style="font-weight: bold;">Coxofemoral</p>
                            <h6>Abduction-adduction links: {{ $sessies->con159 }}</h6>@endif
                            ...
                            <br>                        <p style="font-weight: bold;">Pelvic limb</p>
                            <h6>Protraction links: {{ $sessies->con163 }}</h6>@endif
