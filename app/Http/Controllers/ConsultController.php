...
class ConsultController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CreateConsultRequest $request, Dog $dog)
    {
        Consult::create([
            'dog_id' => $dog->id,
            'con1' => $request->con1,
    ...
    public function show($id)
    {
            ...
            return view('consults.show')->with('consults', $consults)->with('dogs', Dog::all());
    ...
    //             ]);
                    // $dog = Dog::find($id);
                            ...
                            // $dog->save();
                            // session()->flash('success', 'Gegevens succesvol bijgewerkt.');
            ...
            //         }
                    ...
                    // $consults = Consult::find($id);
                    // $consults->con1 = $request->input('con1');
                ...
                //     return view('consults.show')->with('consults', $consults);
    ...
    {
        $consults = Consult::find($id);
        return view('consults.rapport')->with('consults', $consults)->with('dogs', Dog::all());

    }
    public function welcome()
    {
        $consult=Consult::orderBy('updated_at', 'asc');
        return view('welcome', ['consults' => $consult ]);
    }
}
